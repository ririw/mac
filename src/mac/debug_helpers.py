...
def check_shape(
    tensor: torch.Tensor, match: typing.Tuple[typing.Optional[int], ...]
) -> torch.Tensor:
...
__debug__options__ = {"save_locals": False, "locals": None, "debug_stack": []}
...
def get_saved_locals():
    ...
    msg = (
        "No locals found. Ensure your code called save_all_locals() "
